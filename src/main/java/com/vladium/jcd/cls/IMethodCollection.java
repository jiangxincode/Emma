...
// ----------------------------------------------------------------------------
/**
 * An abstraction of the 'methods' component of .class format. The contents are
 * {@link Method_info} structures corresponding to all methods directly declared
 * by this class/interface. The order in which they appear is unspecified.
 * 
...
public interface IMethodCollection extends Cloneable, IClassFormatOutput {
     ...
     * @return array of method offsets in no particular order [never null; could be
     *         empty]
     * 
    ...
    /**
     * Adds a new Method_info descriptor to this collection. No duplicate checks are
     * made. It is the responsibility of the caller to ensure that all data
     * referenced in 'method' will eventually appear in the constant pool.
     * 
    ...
    /**
     * Replaces the Method_info descriptor at a given offset. No duplicate checks
     * are made. No method type compatibility checks are made. It is the
     * responsibility of the caller to ensure that all data referenced in 'method'
     * will eventually appear in the constant pool.
     * 
     * @param offset method offset [must be in [0, size()) range; input not checked]
     * @param method new method descriptor [may not be null]
    ...
    /**
     * Removes the Method_info descriptor at a given offset. It is the
     * responsibility of the caller to ensure that the class definition remains
