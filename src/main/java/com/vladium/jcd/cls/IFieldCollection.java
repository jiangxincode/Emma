...
// ----------------------------------------------------------------------------
/**
 * An abstraction of the 'fields' component of .class format. The contents are
 * {@link Field_info} structures corresponding to all fields directly declared
...
public interface IFieldCollection extends Cloneable, IClassFormatOutput {
     ...
     * @return array of field offsets in no particular order [never null; could be
     *         empty]
     * 
    ...
    /**
     * Adds a new Field_info descriptor to this collection. No duplicate checks are
     * made. It is the responsibility of the caller to ensure that all data
     * referenced in 'field' will eventually appear in the constant pool.
     * 
    ...
    /**
     * Replaces the Field_info descriptor at a given offset. No duplicate checks are
     * made. No field type compatibility checks are made. It is the responsibility
     * of the caller to ensure that all data referenced in 'field' will eventually
