 ...
 * name stored as a simple (not fully qualified) name, that is, as a Java
 * identifier.
 * <P>
 * 
 ...
 * structure. A field can have any number of attributes associated with it. The
 * only attribute defined for the attributes table of a field_info structure at
 * the moment is the ConstantValue attribute -- see
 * {@link ConstantValueAttribute_info}.
 * 
 * @author (C) 2001, Vlad Roubtsov
 */
public final class Field_info implements Cloneable, IAccessFlags {
    // public: ................................................................

    public int m_name_index;
    public int m_descriptor_index;

    public Field_info(final int access_flags, final int name_index, final int descriptor_index,
    ...
    public Field_info(final IConstantCollection constants, final UDataInputStream bytes) throws IOException {
    ...
    public String toString() {
        return "field_info: [modifiers: 0x" + Integer.toHexString(m_access_flags) + ", name_index = " + m_name_index
