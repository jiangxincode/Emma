...
public final class InnerClass_info implements Cloneable, IClassFormatOutput {
    ...
    public InnerClass_info(final int outer_class_index, final int inner_class_index, final int inner_name_index,
    ...
    public String toString() {
        return "innerclass_info: [m_outer_class_index = " + m_outer_class_index + ", m_inner_class_index = "
                + m_inner_class_index + ", m_inner_name_index = " + m_inner_name_index + ", m_inner_access_flags = "
