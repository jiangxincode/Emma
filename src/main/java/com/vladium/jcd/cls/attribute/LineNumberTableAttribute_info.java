 ...
 * attributes table of a {@link CodeAttribute_info} attribute. It may be used by
 * debuggers to determine which part of the JVM code array corresponds to a
 * given line number in the original source file. If LineNumberTable attributes
 * are present in the attributes table of a given Code attribute, then they may
 * appear in any order. Furthermore, multiple LineNumberTable attributes may
 * together represent a given line of a source file; that is, LineNumberTable
 ...
 * </PRE>
 * 
 * Each entry in the line_number_table array indicates that the line number in
 * the original source file changes at a given point in the code array.
 * <P>
 * 
 ...
 * which the code for a new line in the original source file begins. The value
 * of start_pc must be less than the value of the code_length item of the
 * {@link CodeAttribute_info} attribute of which this LineNumberTable is an
 * attribute.
 * <P>
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * The value of the line_number item must give the corresponding line number in
...
public final class LineNumberTableAttribute_info extends Attribute_info {
     ...
     * 
     * @param offset line number entry offset [must be in [0, size()) range; input
     *               not checked]
