...
// ----------------------------------------------------------------------------
/**
 * Abstract base for all XXXAttribute_info structures. It also works in
 * conjunction with {@link GenericAttribute_info} class to process all
 * unrecognized attributes.
 * <P>
 * 
 * Attributes are used in the {@link com.vladium.jcd.cls.ClassDef},
 * {@link com.vladium.jcd.cls.Field_info},
 ...
 * attribute_name_index must be a
 * {@link com.vladium.jcd.cls.constant.CONSTANT_Utf8_info} string representing
 * the name of the attribute. The value of the attribute_length item indicates
 * the length of the subsequent information in bytes. The length does not
...
public abstract class Attribute_info implements Cloneable, IClassFormatOutput {
     ...
     * {@link com.vladium.jcd.cls.constant.CONSTANT_Utf8_info} string representing
     * the name of this attribute [always positive].
     */
    ...
    /**
     * Returns the total length of this attribute when converted to .class format
    ...
    // TODO: use a hashmap lookup in this method + control which set of attrs get
    // mapped to generic
    /**
     * Parses out a single Attribute_info element out of .class data in 'bytes'.
     * 
     * @param constants constant pool for the parent class [may not be null; not
     *                  validated]
     ...
     */
    public static Attribute_info new_Attribute_info(final IConstantCollection constants, final UDataInputStream bytes)
            throws IOException {
    ...
    /**
     * Chains to super.clone() and removes CloneNotSupportedException from the
     * method signature.
     */
    public Object clone() {
        try {
     ...
     * //m_name_index = bytes.readU2 (); //m_attribute_length = bytes.readU4 (); }
     */
    ...
    // TODO: remove this field as it is invalidated easily by most attribute
    // mutations
