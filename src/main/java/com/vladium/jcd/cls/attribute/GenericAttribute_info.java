...
public final class GenericAttribute_info extends Attribute_info {
    ...
    public String toString() {
        return "generic attribute_info: [attribute_name_index = " + m_name_index + ", attribute_length = "
                + m_attribute_length + ']';
    }
    ...
    GenericAttribute_info(final int attribute_name_index, final long attribute_length, final UDataInputStream bytes)
            throws IOException {
