 ...
 * {@link ExceptionHandlerTable}. Each entry contains the following items:
 * 
 * <PRE>
 *    start_pc, end_pc
 * </PRE>
 ...
 * must be the index of the opcode of an instruction, and must be less than the
 * value of the code_length item.
 * 
 * <PRE>
 * catch_type
 * </PRE>
 ...
 * representing a class of exceptions that this exception handler is designated
 * to catch. This class must be the class Throwable or one of its subclasses.
 ...
 */
public final class Exception_info implements Cloneable, IClassFormatOutput {
    // public: ................................................................

    public int m_start_pc, m_end_pc, m_handler_pc, m_catch_type;

    public Exception_info(final int start_pc, final int end_pc, final int handler_pc, final int catch_type) {
        m_start_pc = start_pc;
        m_end_pc = end_pc;
    ...
    public String toString() {
        return "exception_info: [start_pc/end_pc = " + m_start_pc + '/' + m_end_pc + ", handler_pc = " + m_handler_pc
