...
// ----------------------------------------------------------------------------
/**
 * The ConstantValue attribute is a fixed-length attribute used in the
 * attributes table of the {@link com.vladium.jcd.cls.Field_info} structures. A
 * ConstantValue attribute represents the value of a constant field that must be
 * (explicitly or implicitly) static; that is, the ACC_STATIC bit in the flags
 * item of the Field_info structure must be set. The field is not required to be
 * final. There can be no more than one ConstantValue attribute in the
 * attributes table of a given Field_info structure. The constant field
 * represented by the Field_info structure is assigned the value referenced by
 * its ConstantValue attribute as part of its initialization.
 * <P>
 * 
 ...
 * constant pool table. The constant pool entry at that index must give the
 * constant value represented by this attribute.
 * <P>
 * 
 * The constant pool entry must be of a type appropriate to the field, as shown
 * below:
 * 
 * <TABLE>
 * <TR>
...
public final class ConstantValueAttribute_info extends Attribute_info {
    ...
    public String toString() {
        ...
        return "ConstantValueAttribute_info: [attribute_name_index = " + m_name_index + ", attribute_length = "
                + m_attribute_length + ']';
    ...
    ConstantValueAttribute_info(final int attribute_name_index, final long attribute_length,
        ...
        if (DEBUG)
            System.out.println("\tconstantvalue_index: " + m_value_index);
    }
