...
// ----------------------------------------------------------------------------
/**
 * The Exceptions attribute is a variable-length attribute used in the
 * attributes table of a {@link com.vladium.jcd.cls.Method_info} structure. The
 * Exceptions attribute indicates which checked exceptions a method may throw.
 * There must be exactly one Exceptions attribute in each method_info structure.
 * <P>
 * 
 ...
 * {@link com.vladium.jcd.cls.constant.CONSTANT_Class_info} structure
 * representing a class type that this method is declared to throw -- see
 * {@link DeclaredExceptionTable}.
 * 
...
public final class ExceptionsAttribute_info extends Attribute_info {
    ...
    public ExceptionsAttribute_info(final int attribute_name_index, final IDeclaredExceptionTable exceptions) {
    ...
    public String toString() {
        ...
        return "ExceptionsAttribute_info: [attribute_name_index = " + m_name_index + ", attribute_length = "
                + m_attribute_length + ']';
    }
    ...
    ExceptionsAttribute_info(final int attribute_name_index, final long attribute_length, final UDataInputStream bytes)
            throws IOException {
