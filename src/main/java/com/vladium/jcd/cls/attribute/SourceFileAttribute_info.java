...
public final class SourceFileAttribute_info extends Attribute_info {
    ...
    public String toString() {
        return "SourceFileAttribute_info: [attribute_name_index = " + m_name_index + ", attribute_length = "
                + m_attribute_length + ']';
    }
    ...
    SourceFileAttribute_info(final int attribute_name_index, final long attribute_length, final UDataInputStream bytes)
            throws IOException {
