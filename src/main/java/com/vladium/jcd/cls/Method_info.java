...
// ----------------------------------------------------------------------------
/**
 * Each class method, and each instance initialization method <init>, is
 * described by a variable-length method_info structure. The structure has the
 * following format:
 * 
 * <PRE>
 *  method_info {
 ...
 * access permission to and properties of a method or instance initialization
 * method.
 * <P>
 * 
 ...
 * {@link CONSTANT_Utf8_info} structure representing either one of the special
 * internal method names, either &lt;init&gt; or &lt;clinit&gt;, or a valid Java
 * method name, stored as a simple (not fully qualified) name.
 * <P>
 * 
 * The value of the descriptor_index item must be a valid index into the
 * constant pool table. The constant pool entry at that index must be a
 * {@link CONSTANT_Utf8_info} structure representing a valid Java method
 * descriptor.
 * <P>
 * 
 * Each value of the attributes table must be a variable-length attribute
 * structure. A method can have any number of optional attributes associated
 * with it. The only attributes defined by this specification for the attributes
 * table of a method_info structure are the Code and Exceptions attributes. See
 * {@link CodeAttribute_info} and {@link ExceptionsAttribute_info}.
 * 
...
public final class Method_info implements Cloneable, IAccessFlags {
    ...
    public Method_info(final IConstantCollection constants, final UDataInputStream bytes) throws IOException {
    ...
    public String toString() {
        ...
        s.append("method_info: [modifiers: 0x" + Integer.toHexString(m_access_flags) + ", name_index = " + m_name_index
                + ", descriptor_index = " + m_descriptor_index + "]\n");
