...
public interface IAttributeCollection extends Cloneable, IClassFormatOutput {
     ...
     * 
     * @param offset attribute offset [must be in [0, size()) range; input not
     *               checked]
    ...
    /**
     * Returns the total length of this collection when converted to .class format
    ...
    /**
     * Adds a new Attribute_info descriptor to this collection. No duplicate checks
     * are made. It is the responsibility of the caller to ensure that all data
     * referenced in 'attribute' will eventually appear in the constant pool.
     * 
    ...
    /**
     * Replaces the Attribute_info descriptor at a given offset. No duplicate checks
     * are made. It is the responsibility of the caller to ensure that all data
     * referenced in 'attribute' will eventually appear in the constant pool.
     * 
     * @param offset    attribute offset [must be in [0, size()) range; input not
