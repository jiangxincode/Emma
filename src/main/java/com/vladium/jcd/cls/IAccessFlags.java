...
public interface IAccessFlags {
    ...
    static final int ALL_ACC[] = new int[] { ACC_PUBLIC, ACC_PRIVATE, ACC_PROTECTED, ACC_STATIC, ACC_FINAL,
            ACC_SYNCHRONIZED, ACC_VOLATILE, ACC_TRANSIENT, ACC_NATIVE, ACC_INTERFACE, ACC_ABSTRACT, };

    static final String ALL_ACC_NAMES[] = new String[] { "public", "private", "protected", "static", "final",
