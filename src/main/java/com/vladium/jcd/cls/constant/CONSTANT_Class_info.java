 ...
 * {@link CONSTANT_Utf8_info} structure representing a valid fully qualified
 * Java class name that has been converted to the class file's internal form.
 * 
...
public final class CONSTANT_Class_info extends CONSTANT_info {
    ...
    /**
     * Returns the JVM class name within the constant pool context of 'cls' class
     * definition.
     * 
