...
// ----------------------------------------------------------------------------
/**
 * An RPC response object, containing an int ID (matching its request ID) and a
 * Serializable payload object.
 * 
...
public class Response {
    ...
    public static Response read(final DataInputStream in) throws IOException, ClassNotFoundException {
    ...
    public static void write(final Response response, final DataOutputStream out) throws IOException {
