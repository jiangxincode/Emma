...
public class Request {
    ...
    public static Request read(final DataInput in) throws IOException {
    ...
    public static void write(final Request request, final DataOutput out) throws IOException {
