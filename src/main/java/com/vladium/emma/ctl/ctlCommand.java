...
//                }
    ...
    /**
     * A helper method for tokenizing a string based on given delimiters. Unlike the
     * usual StringTokenizer behavior, this does not merge consequitive tokenizers
     * into one.
     * 
    ...
    public static String[] tokenize(final String s, final String delimiters, final boolean trim) {
        // BUG_SF1275523: made this method public to avoid known J2SE bugs with access
        // checking during reflection
