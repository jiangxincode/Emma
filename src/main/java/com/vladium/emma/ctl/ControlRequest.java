...
// ----------------------------------------------------------------------------
/**
 * ControlRequest represents a runtime control command. Each such object has a
 * numeric ID, a user-friendly name, and an array of String arguments.
...
public final class ControlRequest extends Request {
     ...
     * <dl>
     * <dt>delay</dt>
     * <dd>server-side delay (ms) before replying</dd>
     * </dl>
     */
     ...
     * <dl>
     * <dt>local pathname</dt>
     * <dd>optional local pathname to use for persisting downloaded coverage data by
     * the client JVM</dd>
     * <dt>true|false</dt>
     * <dd>optional merge flag</dd>
     * <dt>true|false</dt>
     * <dd>optional flag to indicate whether to disable coverage dump exit hook</dd>
     * </dl>
     */
     ...
     * <dl>
     * <dt>remote pathname</dt>
     * <dd>optional remote pathname to use for dumping coverage data by the server
     * JVM</dd>
     * <dt>true|false</dt>
     * <dd>optional merge flag</dd>
     * <dt>true|false</dt>
