...
public interface IAppConstants extends IAppVersion {
    ...
    String APP_VERBOSE_BUILD_ID = "[" + APP_NAME + " v" + APP_VERSION + ", build " + APP_BUILD_ID_AND_TAG + " ("
            + APP_BUILD_DATE + ")]";
    ...
    /*
     * This field needs to be incremented every time data serialization format gets
     * a backwards-incompatible change (which does not necessarily happen during
     * each major/minor app version change).
     */
