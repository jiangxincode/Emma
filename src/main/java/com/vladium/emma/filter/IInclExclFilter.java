...
public interface IInclExclFilter {
    ...
    abstract class Factory {
        ...
        public static IInclExclFilter create(final List /* String */ inclusions, final List /* String */ exclusions) {
            return new WCInclExclFilter(inclusions, exclusions);
        }
        ...
        private static final class WCInclExclFilter implements IInclExclFilter {
            ...
            WCInclExclFilter(final List /* String */ inclusions, final List /* String */ exclusions) {
