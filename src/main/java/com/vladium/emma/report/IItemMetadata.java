...
public interface IItemMetadata {
    ...
    abstract class Factory {
        ...
        static {
            ...
            METADATA = new IItemMetadata[] { AllItem.getTypeMetadata(), PackageItem.getTypeMetadata(),
                    SrcFileItem.getTypeMetadata(), ClassItem.getTypeMetadata(), MethodItem.getTypeMetadata(), };
        }
