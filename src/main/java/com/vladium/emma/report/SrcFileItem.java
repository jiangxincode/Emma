...
public final class SrcFileItem extends Item {
    ...
    public final class LineCoverageData {
        ...
        public final int[/* units mode */][/* total, coverage */] m_coverageRatio; // not null in LINE_COVERAGE_PARTIAL
                                                                                   // status only]
            ...
            case COVERAGE_LINE_INSTR: {
                ...
                for (int cl = 0; cl < lineCount; ++cl) {
                    ...
                    if (lcoverageInstr == 0)
                        ...
                        lcoverageRatio = new int[][] { { ltotalCount, lcoverageCount },
                                { ltotalInstr, lcoverageInstr } }; // note: ordering depends on IItemAttribute.UNITS_xxx
                    }
    ...
    static {
        METADATA = new Item.ItemMetadata(IItemMetadata.TYPE_ID_SRCFILE, "srcfile", 1 << IItemAttribute.ATTRIBUTE_NAME_ID
