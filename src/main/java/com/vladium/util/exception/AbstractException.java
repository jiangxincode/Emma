...
// ----------------------------------------------------------------------------
/**
 * Based on code published by me in <a href=
 * "http://www.fawcette.com/javapro/2002_12/online/exception_vroubtsov_12_16_02/default_pf.asp">JavaPro,
 * 2002</a>.
 * <P>
 * 
 * This checked exception class is designed as a base/expansion point for the
 * entire hierarchy of checked exceptions in a project.
 * <P>
 * 
 * It provides the following features:
 * <UL>
 * <LI>ability to take in compact error codes that map to full text messages in
 * a resource bundle loaded at this class' instantiation time. This avoids
 * hardcoding the error messages in product code and allows for easy
 * localization of such text if required. Additionally, these messages can be
 * parametrized in the java.text.MessageFormat style;
 * <LI>exception chaining in J2SE versions prior to 1.4
 * </UL>
 * 
 * See {@link AbstractRuntimeException} for an unchecked version of the same
 * class.
 * <P>
 *
 * TODO: javadoc
 ...
 * <CODE>com.vladium.exception.exceptions</CODE> resource bundle or your
 * project/exception class-specific resource bundle [see
 ...
 * <P>
 *
 * All constructors taking an 'arguments' parameter supply parameters to the
 * error message used as a java.text.MessageFormat pattern.
 * <P>
 * 
 * Example:
 * 
 ...
 * across independently developed exception families, as long as resource
 * bundles use unique names. Specifically, error codes follow inheritance and
 * hiding rules similar to Java class static methods. See
 * {@link ExceptionCommon#addExceptionResource} for further details.
 *
 * @author Vlad Roubtsov, (C) 2002
 */
public abstract class AbstractException extends Exception implements ICodedException, IThrowableWrapper {
    // public: ................................................................
     ...
     *
     * @return String error message provided at construction time or the result of
     *         toString() if no/null message was provided [never null].
     */
    public final String getMessage() {
        if (m_message == null) // not synchronized by design
        {
            ...
            if (msg == null) {
                // this is the same as what's done in Throwable.toString() [copied here to be
                // independent of future JDK changes]
    ...
    /**
     * Overrides Exception.printStackTrace() to (a) force the output to go to
     * System.out and (b) handle nested exceptions in JDKs prior to 1.4.
     * <P>
     * 
    ...
    /**
     * Overrides Exception.printStackTrace() to handle nested exceptions in JDKs
     * prior to 1.4.
     * <P>
     * 
     * Subclasses cannot override.
    ...
    /**
     * Returns the String that was passed as 'message' constructor argument. Can be
     * null.
     *
    ...
    /**
     * This implements {@link IThrowableWrapper} and also overrides the base method
     * in JDK 1.4+.
     */
     ...
     */
    public static void addExceptionResource(final Class namespace, final String messageResourceBundleName) {
    ...
    // note: this field duplicates functionality available in stock Throwable in JRE
    // 1.4+
