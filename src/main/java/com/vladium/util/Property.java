...
public abstract class Property {
    ...
    /**
     * NOTE: this does not guarantee that the result will be mutatable independently
     * from 'overrides' or 'base', so this method should be used for read-only
     * property only
     * 
    ...
    /**
     * Creates a set of properties for an application with a given namespace. This
     * method is not property aliasing-aware.
     * 
     ...
     * @return application properties [never null, a new instance is created on each
     *         invocation]
     */
     ...
     */
    public static Properties getPropertiesFromFile(final File file) throws IOException {
        if (file == null)
            ...
            if ((contents == null) && (m_src != null)) {
                try {
                    ...
                    throw new RuntimeException(
                            "exception while processing properties file [" + m_src.getAbsolutePath() + "]: " + e);
                }
            }
...
//                    ignore.printStackTrace (System.out);
    ...
    private static final class SystemRedirectsLookup extends XProperties {
        ...
        public synchronized Enumeration keys() {
            ...
            if (m_systemRedirects != null) {
                for (Iterator i = m_systemRedirects.keySet().iterator(); i.hasNext();) {
                    final Object key = i.next();
                    if ((key != null) && (get(key) != null)) // guard against a redirect not working due to security
                                                             // restrictions, etc
                    {
