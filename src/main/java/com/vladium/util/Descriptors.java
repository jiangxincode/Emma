...
public abstract class Descriptors {
     ...
     */
    public static String methodVMNameToJavaName(final String className, final String methodVMName,
            final String descriptor, final boolean renameInits, final boolean shortTypeNames,
...
//    }
    ...
    private static int typeDescriptorToJavaName(final char[] descriptor, int start, final boolean shortTypeNames,
            final StringBuffer out) {
        int dims;
