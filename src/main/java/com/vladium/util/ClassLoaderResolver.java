 ...
 * choosing a ClassLoader for dynamic class/resource loading at any point in an
 * application.
 * 
 * @see ResourceLoader
...
public abstract class ClassLoaderResolver {
     ...
     * class/resource loading by whoever calls this method. The decision typically
     * involves choosing between the caller's current, thread context, system, and
     * other classloaders in the JVM and is made by the {@link IClassLoadStrategy}
     * instance established by the last call to {@link #setStrategy}.
     * <P>
     * 
     * This method does not throw.
     * 
     * @param caller [null input eliminates the caller's current classloader from
     *               consideration]
     * 
     * @return classloader to be used by the caller ['null' indicates the primordial
     *         loader]
     */
    ...
    public static Class getCallerClass(final int callerOffset) {
        if (CALLER_RESOLVER == null)
            return null; // only happens if <clinit> failed
     ...
     * 'loader1'=='loader2']. Of course, this works only for classloaders that set
     * their parent pointers correctly. 'null' is interpreted as the primordial
    ...
    /**
     * Sets the classloader selection strategy to be used by subsequent calls to
     * {@link #getClassLoader()}. An instance of
     * {@link ClassLoaderResolver.DefaultClassLoadStrategy} is in effect if this
     ...
     * getClassContext() accessible. An instance of CallerResolver only needs to be
     * created, not installed as an actual security manager.
     */
