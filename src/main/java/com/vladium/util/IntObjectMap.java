...
public final class IntObjectMap implements Serializable {
     ...
     *
     * @param initialCapacity initial number of hash buckets in the table [may not
     *                        be negative, 0 is equivalent to 1].
     ...
     * key has never been mapped or (b) it has been mapped to a null value.
     *
